...
BOOL Light::SetDiffuseColor(float Red, float Green, float Blue)
{
...
BOOL Light::GetDiffuseColor(float *Red, float *Green, float *Blue)
{
	if (Red != NULL)
		*Red = (float)(255.0f * m_Light.Diffuse.r);

	if (Green != NULL)
		*Green = (float)(255.0f * m_Light.Diffuse.g);

	if (Blue != NULL)
		*Blue = (float)(255.0f * m_Light.Diffuse.b);

	return TRUE;
}

BOOL Light::SetSpecularColor(float Red, float Green, float Blue)
{
...
BOOL Light::GetSpecularColor(float *Red, float *Green, float *Blue)
{
	if (Red != NULL)
		*Red = (float)(255.0f * m_Light.Specular.r);

	if (Green != NULL)
		*Green = (float)(255.0f * m_Light.Specular.g);

	if (Blue != NULL)
		*Blue = (float)(255.0f * m_Light.Specular.b);

	return TRUE;
}

BOOL Light::SetAmbientColor(float Red, float Green, float Blue)
{
...
BOOL Light::GetAmbientColor(float *Red, float *Green, float *Blue)
{
	if (Red != NULL)
		*Red = (float)(255.0f * m_Light.Ambient.r);

	if (Green != NULL)
		*Green = (float)(255.0f * m_Light.Ambient.g);

	if (Blue != NULL)
		*Blue = (float)(255.0f * m_Light.Ambient.b);
